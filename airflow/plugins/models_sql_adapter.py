...
from domain_model import Model


class ModelsSqlAdapter:
    ...
    def get_model_by_file_name(self, file_name: str) -> Model | None:
        with psycopg.connect(
                dbname=self._dbconnection.dbname,
                user=self._dbconnection.user,
                password=self._dbconnection.password,
            ...
            with conn.cursor() as cur:
                ...
                return Model.from_dict(row_dict)
    ...
    def _insert_model_internal(self, model: Model) -> None:
        with psycopg.connect(
                dbname=self._dbconnection.dbname,
                user=self._dbconnection.user,
                password=self._dbconnection.password,
